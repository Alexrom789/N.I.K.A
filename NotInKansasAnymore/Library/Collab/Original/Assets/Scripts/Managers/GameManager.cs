...
public class GameManager : MonoBehaviour
{
    ...
    public static int[] fastEnemyWaves = new int[]      {0, 0, 0, 1, 0,  0,  0};
    public static int[] tankEnemyWaves = new int[]      {0, 0, 0, 0, 1,  0,  0};
    public static int[] regEnemyWaves = new int[]       {0, 1, 0, 0, 0,  1,  1};
    public static int[] rangedEnemyWaves = new int[]    {0, 0, 1, 0, 0,  0,  0};
    */

    public static int[] fastEnemyWaves = new int[]      {0, 0};
    public static int[] tankEnemyWaves = new int[]      {0, 2};
    public static int[] regEnemyWaves = new int[]       {0, 8};
    ...
    void CreateEnemyList() {
        ...
        for (int i = 0; i < rangedEnemyWaves[currentWave]; i++) {
    ...
    void SetWave(int wave) {
        currentWave = wave;
        foesLeft = fastEnemyWaves[currentWave] + regEnemyWaves[currentWave] + tankEnemyWaves[currentWave] + rangedEnemyWaves[currentWave];
